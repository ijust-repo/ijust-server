...
git clone https://gitlab.com/ijust/server
git clone https://gitlab.com/ijust/frontend
mkdir log
touch reload
...
letsencrypt certonly --email=mdan.hagh@gmail.com --agree-tos -d acm.iust.ac.ir ijust.ir www.ijust.ir
